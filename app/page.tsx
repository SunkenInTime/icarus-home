      ...
      <nav className="relative z-10 backdrop-blur-md bg-black/20 border-b border-white/10">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#beta" className="text-gray-300 hover:text-white transition-colors">Beta</a>
      ...
      <main className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-xl">
                The next evolution in Valorant strategy planning. Local-first, intuitive, and designed for competitive players.
              </p>
            ...
            >
              <div className="relative">
                ...
                <div className="relative bg-gray-900 rounded-xl overflow-hidden border border-white/10">
                  <div className="h-[400px] w-full bg-gray-800 flex items-center justify-center">
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                Designed from the ground up to address the shortcomings of existing tools
              </p>
            </div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="py-4 px-6 text-center bg-gradient-to-r from-red-900/20 to-transparent">Icarus</th>
              ...
              <tbody>
                {comparisonItems.map((item, index) => (
                  <tr key={index} className="border-b border-white/5 hover:bg-white/5">
                    ...
                    <td className="py-4 px-6 text-center bg-gradient-to-r from-red-900/10 to-transparent">
                      <span className={item.icarus ? "text-green-500" : "text-red-500"}>
                        {item.icarus ? "✓" : "✗"}
                      </span>
                    </td>
                    <td className="py-4 px-6 text-center">
                      <span className={item.competitors ? "text-green-500" : "text-red-500"}>
                        {item.competitors ? "✓" : "✗"}
                      </span>
                    </td>
                  </tr>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative bg-gray-900 rounded-xl overflow-hidden border border-white/10">
                    <div className="h-[350px] w-full bg-gray-800 flex items-center justify-center">
              ...
              >
                ...
                <p className="text-gray-400">
                  Icarus is approaching its 1.0 release, with new features being added
                  regularly. Join our growing community of testers and help shape the
                  future of Valorant strategy planning.
                </p>

                <div className="space-y-4 pt-4">
                  <h3 className="text-xl font-bold text-red-500">Coming Soon</h3>
        ...
        <section id="download" className="py-24 container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Download the beta version and join the revolution in Valorant strategy planning
            </p>
          </div>
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 mb-6">
                      Version 0.9.2 Beta • Released May 15, 2024
                    </p>
                    <button className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-8 py-4 rounded-lg transition-all font-medium flex items-center justify-center gap-2 shadow-lg shadow-red-900/20">
        ...
        <section id="community" className="py-24 bg-black/30 backdrop-blur-sm">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto mb-12">
              Connect with other users, share strategies, and contribute to the development of Icarus
            </p>
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-red-600/20 flex items-center justify-center transition-colors">
                <FaGithub />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-red-600/20 flex items-center justify-center transition-colors">
                <FaDiscord />
...
const features = [
  {
    icon: <svg className="w-6 h-6 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" /></svg>,
  ...
  {
    icon: <svg className="w-6 h-6 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>,
    title: "Open Source",
    description:
